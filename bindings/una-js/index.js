...
switch (platform) {
  case 'android':
    switch (arch) {
      case 'arm64':
        localFileExisted = existsSync(join(__dirname, 'una.android-arm64.node'))
        try {
          if (localFileExisted) {
        ...
        break
      case 'arm':
        localFileExisted = existsSync(join(__dirname, 'una.android-arm-eabi.node'))
        try {
          if (localFileExisted) {
    ...
    switch (arch) {
      case 'x64':
        localFileExisted = existsSync(
          join(__dirname, 'una.win32-x64-msvc.node')
        )
        try {
          if (localFileExisted) {
      ...
      case 'ia32':
        localFileExisted = existsSync(
          join(__dirname, 'una.win32-ia32-msvc.node')
        )
        try {
          if (localFileExisted) {
      ...
      case 'arm64':
        localFileExisted = existsSync(
          join(__dirname, 'una.win32-arm64-msvc.node')
        )
        try {
          if (localFileExisted) {
  ...
  case 'darwin':
    switch (arch) {
      case 'x64':
        localFileExisted = existsSync(join(__dirname, 'una.darwin-x64.node'))
        try {
          if (localFileExisted) {
      ...
      case 'arm64':
        localFileExisted = existsSync(
          join(__dirname, 'una.darwin-arm64.node')
        )
        try {
          if (localFileExisted) {
  ...
  case 'freebsd':
    ...
    localFileExisted = existsSync(join(__dirname, 'una.freebsd-x64.node'))
    try {
      if (localFileExisted) {
  ...
  case 'linux':
    switch (arch) {
      case 'x64':
        if (isMusl()) {
          localFileExisted = existsSync(
            join(__dirname, 'una.linux-x64-musl.node')
          )
          try {
            if (localFileExisted) {
          ...
          localFileExisted = existsSync(
            join(__dirname, 'una.linux-x64-gnu.node')
          )
          try {
            if (localFileExisted) {
      ...
      case 'arm64':
        if (isMusl()) {
          localFileExisted = existsSync(
            join(__dirname, 'una.linux-arm64-musl.node')
          )
          try {
            if (localFileExisted) {
          ...
          localFileExisted = existsSync(
            join(__dirname, 'una.linux-arm64-gnu.node')
          )
          try {
            if (localFileExisted) {
      ...
      case 'arm':
        localFileExisted = existsSync(
          join(__dirname, 'una.linux-arm-gnueabihf.node')
        )
        try {
          if (localFileExisted) {
